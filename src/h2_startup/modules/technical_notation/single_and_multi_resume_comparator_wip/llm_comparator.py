...
class LLMComparator:
    ...
    def call_comparator(
        ...
        for resume in list_resume:
            ...
            #         scale=scale,
            #     )
            # self._save_dict(marked_json, path=f"/workspace/temp/2023DOS0550696/resume_{it}.json")
            if it < 4:
                cv_json_file_path = f"/workspace/temp/2023DOS0550696/resume_{it}.json"
        ...
        formated_response, formated_jsons_response = self._call_comparator_multi_resume(
            requirements=requirements,
            list_marked_jsons=list_marked_jsons,
    ...
    def _call_comparator_multi_resume(
        ...
        formated_jsons_response = []
        try:
            list_resume = self._extract_between_tags(
                tag="json_output", string=formated_response
            )
            print(list_resume)
            for resume in list_resume:
        ...
        return formated_response, formated_jsons_response
