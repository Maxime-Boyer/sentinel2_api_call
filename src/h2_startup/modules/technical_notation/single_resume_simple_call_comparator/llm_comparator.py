...
from h2_startup.modules.technical_notation.single_resume_simple_call_comparator.metaprompt import (
    metaprompt,
)
...
class LLMComparator:
    ...
    def call_comparator(
        ...
        formated_json_response = json.loads(
            self._extract_between_tags(tag="json_output", string=formated_response)[0]
        )

        score = self._aggregate_marks(criterias, formated_json_response)

        return formated_response, formated_json_response, score
